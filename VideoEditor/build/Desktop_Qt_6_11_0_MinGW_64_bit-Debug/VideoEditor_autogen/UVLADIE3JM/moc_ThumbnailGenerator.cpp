...
template <> constexpr inline auto ThumbnailGenerator::qt_create_metaobjectdata<qt_meta_tag_ZN18ThumbnailGeneratorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QString &, qint64, QPixmap)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { QMetaType::LongLong, 4 }, { 0x80000000 | 5, 6 },
        }}),
    };
...
void ThumbnailGenerator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->thumbnailReady((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<qint64>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QPixmap>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ThumbnailGenerator::*)(const QString & , qint64 , QPixmap )>(_a, &ThumbnailGenerator::thumbnailReady, 0))
            return;
    }
}
...
// SIGNAL 0
void ThumbnailGenerator::thumbnailReady(const QString & _t1, qint64 _t2, QPixmap _t3)
{
